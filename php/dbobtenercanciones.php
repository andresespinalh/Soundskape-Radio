<?php
    ...
    $result = $conn->query("SELECT b.id_cancion as 'id_cancion',titulo,duracion,nombre_artistico,direccion 
                            FROM artista_por_cancion a, cancion b,artista c 
                            WHERE (a.id_cancion=b.id_cancion) 
                                and (a.id_artista=c.id_artista) 
